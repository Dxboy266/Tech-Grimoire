...
**注意:** id字段不用填,因为它是AUTO_INCREMENT,MySQL会自动分配。
...
![image.png](https://p0-xtjj-private.juejin.cn/tos-cn-i-73owjymdk6/c6f88433f58349169e72a39259dd8450~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg6aqR552AYnVn55qEY29kZXI=:q75.awebp?policy=eyJ2bSI6MywidWlkIjoiMTkyMjQxODU3OTA4OTU2NiJ9&rk3s=f64ab15b&x-orig-authkey=f32326d3454f2ac7e96d3d06cdbb035152127018&x-orig-expires=1765114058&x-orig-sign=uH1UUHxr1ARkoIxhCLYXns9hVVk%3D)
...
- department:部门表(dept_name, location)
...
| DATE_FORMAT | 格式化日期 | `SELECT DATE_FORMAT(hire_date, '%Y年%m月')` |
| DATEDIFF | 日期差(天) | `SELECT DATEDIFF(NOW(), hire_date)` |
| DATE_ADD | 日期加减 | `SELECT DATE_ADD(NOW(), INTERVAL 7 DAY)` |
...
> 📸 **截图5:** 常用函数的执行结果(DATEDIFF、DATE_FORMAT的应用)
...
- 数字:ROUND、CEIL、FLOOR
- 日期:NOW、DATEDIFF、DATE_FORMAT、DATE_ADD
